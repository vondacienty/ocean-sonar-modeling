...
def main(argv: list[str] | None = None) -> int:
    ...
    audit_parser = sub.add_parser("audit-comparisons", help="audit comparison JSON files and print one JSON summary line")
    audit_parser.add_argument("audit_first", metavar="FILE", help="first comparison JSON file")
    audit_parser.add_argument("audit_second", metavar="FILE", help="second comparison JSON file")
    audit_parser.add_argument("audit_rest", nargs="*", metavar="FILE", help="additional comparison JSON files")
