...
def main(argv: list[str] | None = None) -> int:
    ...
    render_audit_parser = sub.add_parser("render-audit", help="render an audit JSON file as two text lines")
    render_audit_parser.add_argument("audit", metavar="AUDIT", help="audit JSON file produced by export-audit")
